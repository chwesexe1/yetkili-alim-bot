...
module.exports = (client) => {
    client.on("interactionCreate", async interaction => {  
        ...
        if (interaction.customId === "emin") {       
            ...
            .setColor("Blurple")
            .setDescription("Merhaba, Lequnes sunucumuz için yetkili başvurusu yaptığınızı görüyorum. Size soracağım soruları cevaplayarka başvurunuzu yetkililere ileteceğim.\n\n**1.** Hangi yazılım dillerini biliyorsunuz?")
            .setFooter({ text: interaction.guild.name, iconURL: interaction.guild.iconURL({dynamic:true}) })
        ...
        if (interaction.customId === "soru1") {
            ...
            const soru2 = EmbedBuilder.from(interaction.message.embeds[0]).setDescription("**2.** <#1110645160343257142> kanalında kullanıcalara yardım edebilmek için kod yazma seviyeniz nedir?")
